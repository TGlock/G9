...
//ENCRYPT_KEY must be 256 bits (32 characters) e.g. 1c85016910bc4b863aa76a8eca923f83

//can be generated via crypto.randomBytes(16).toString("hex") or manually: a_32_char_len_encryption_key_123
//should be stored in process.env.ENCRYPT_KEY

// TODO refactor this as class...
const set_encrypt_key = (key) => {
    ENCRYPT_KEY = key
}
...
let ENCRYPT_KEY = key_create(16, 'hex')
