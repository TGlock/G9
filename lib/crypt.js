...
/* uncomment to test hash verify funcs
let pwd_text = 'my big secret'
let pwd_hash = await hash(pwd_text)
assert(await verify(pwd_text, pwd_hash))
note the salt is stored in the hash (like bcrypt) https://stackoverflow.com/questions/6832445/how-can-bcrypt-have-built-in-salts
*/
